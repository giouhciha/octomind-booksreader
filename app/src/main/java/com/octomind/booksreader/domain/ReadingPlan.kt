...
object ReadingPlanBuilder {
    ...
    private val invisibleFormattingMarks =
        setOf(
            '\u200B',
            '\u200C',
            '\u200D',
    ...
    private val nonTerminalAbbreviations =
        setOf(
            "sr.",
            "sra.",
            "srta.",
    ...
    fun build(
        ...
        paragraphSeparator
            ...
            .forEachIndexed { paragraphIndex, paragraphText ->
                val paragraphStart =
                    text.indexOf(paragraphText, searchFrom).let { found ->
                ...
                while (wordIndex < words.size) {
                    ...
                    val lexicalWordCount =
                        (wordIndex until blockEndWord)
    ...
    private fun classifyStandaloneDashes(words: List<MatchResult>): Map<Int, StandaloneDashRole> {
        ...
        words.forEachIndexed { index, word ->
            ...
            if (index == 0 || followsSentenceEnd) {
                ...
                nextAsideRole =
                    if (nextAsideRole == StandaloneDashRole.OPENING) {
    ...
    private fun maximumBlockEnd(
        ...
        val remainingLexicalWords =
            (startWord until words.size)
                .count { index -> standaloneDashRoles[index] == null }
    ...
    private fun isNonTerminalAbbreviation(
        words: List<MatchResult>,
        index: Int,
    ): Boolean {
        ...
        val normalized =
            java.text.Normalizer
                .normalize(token.lowercase(), java.text.Normalizer.Form.NFD)
                .replace(Regex("\\p{M}+"), "")
    ...
    private fun String.isStandaloneDash(): Boolean =
        this == "-" ||
