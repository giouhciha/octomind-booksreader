...
object ReaderCalibrationCalculator {
    ...
    fun accepts(elapsedMillis: Long): Boolean =
        elapsedMillis in MIN_TAP_INTERVAL_MILLIS..MAX_TAP_INTERVAL_MILLIS
    ...
    fun estimateWordsPerMinute(
        ...
        val estimates = samples.mapNotNull { sample ->
            ...
            val readingMillis = (sample.elapsedMillis - sample.linguisticPauseMillis)
        ...
        val median = if (estimates.size % 2 == 0) {
